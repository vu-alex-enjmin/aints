...
{    
    public:
        ...
        */
        ...
        CombatState *CurrentCombatState_p;
        ...
        */
        ...
        CombatEvaluator(State *gameState_p);
        ...
        void ComputeBestMove(CombatState *startingCombatState_p);
    ...
    private:
        ...
        */
        ...
        void Initialize(CombatState *startingCombatState_p);
